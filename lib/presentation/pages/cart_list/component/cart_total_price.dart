                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        '상품할인금액',
                        style: textTheme.titleSmall?.copyWith(color: colorScheme.contentPrimary).regular,
                      ),
                      Text(
                        '0원',
                        style: textTheme.titleLarge
                      ...
                      Text.rich(
                        TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text: '원',
                              style: textTheme.titleMedium?.copyWith(color: colorScheme.contentPrimary).regular,
                            ),
                          ],
                        ),
                      ),
