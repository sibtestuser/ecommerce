...
class CartProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16).add(EdgeInsets.only(top: 20)),
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            child: SvgPicture.asset(
              (isSelected) ? AppIcons.checkMarkCircleFill : AppIcons.checkMarkCircle,
              width: 28,
              height: 28,
            ...
            onTap: () => context.read<CartListBloc>().add(CartListSelected(cart: cart)),
          ),
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Align(
                              ...
                              child: Text(
                                cart.product.title,
                                style: textTheme.titleSmall?.titleCopywith().regular,
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          SvgIconButton(
                                            ...
                                            onPressed: () => context.read<CartListBloc>().add(CartListQtyDecreased(
                                                  cart: cart,
                                                )),
                                          ),
                                          Text(
                                          ...
                                          SvgIconButton(
                                            ...
                                            // iconSize: 16,
                                            color: colorScheme.contentPrimary,
                                            onPressed: () => context.read<CartListBloc>().add(CartListQtyIncreased(
                                                  cart: cart,
                                                )),
                                          ),
                                        ],
