...
class _BrandProduct extends StatelessWidget {
  ...
  const _BrandProduct({super.key, required this.productInfo});
                  ...
                  Row(
                    children: [
                      Text(
                        ...
                        style: textStyle.labelLarge?.discountCopywith(),
                      ),
                      SizedBox(
                        width: 4,
                      ),
                      ...
                      Text(
                        ...
                        style: textStyle.labelLarge?.originalPriceCopywith(),
                      ),
                      SizedBox(
                        width: 4,
                      ),
            ...
            child: TextButton(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text('담기', style: textStyle.titleSmall?.copyWith(color: colorScheme.contentPrimary).regular),
                ],
              ),
            ),
          ),
