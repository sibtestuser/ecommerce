...
mixin _$CartState {
  ...
  int get totlaPrice => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      quantity: null == quantity
          ...
          : quantity // ignore: cast_nullable_to_non_nullable
              as int,
      totlaPrice: null == totlaPrice
          ? _value.totlaPrice
          : totlaPrice // ignore: cast_nullable_to_non_nullable
              as int,
    ) as $Val);
  }
...
class _$CartStateImpl implements _CartState {
  ...
  @override
  String toString() {
    return 'CartState(status: $status, error: $error, productInfo: $productInfo, quantity: $quantity, totlaPrice: $totlaPrice)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.totlaPrice, totlaPrice) ||
                other.totlaPrice == totlaPrice));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, status, error, productInfo, quantity, totlaPrice);
...
abstract class _CartState implements CartState {
  factory _CartState(
      ...
      final ProductInfo productInfo,
      final int quantity,
      final int totlaPrice}) = _$CartStateImpl;
