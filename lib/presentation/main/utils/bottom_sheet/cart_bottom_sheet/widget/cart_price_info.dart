...
class CartPriceInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void _qtyIncreased() => context.read<CartBloc>().add(CartQuantityIncreased());
    void _qtyDecreased() => context.read<CartBloc>().add(CartQuantityDecreased());
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      '$quantity',
                      style: textTheme.labelLarge?.copyWith(color: colorScheme.contentPrimary).semiBold,
                    ),
                    SvgIconButton(
                      icon: AppIcons.add,
                      color: quantity != 1 ? colorScheme.contentFourth : colorScheme.contentPrimary,
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text(
                  '적립',
                  style: textTheme.labelSmall.semiBold?.copyWith(color: colorScheme.background),
                ),
              ),
